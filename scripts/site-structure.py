...
IT_PHOTO_SECTION = '''\n    <section class="photo-door" id="fotografie">\n      <div class="photo-door-inner reveal">\n        <div>\n          <p class="kicker">04 · Fotografie</p>\n          <h2>Immagini\nche ricordano.</h2>\n        </div>\n        <div class="photo-door-copy">\n          <p>Fotografie originali, luoghi e memoria. Alcune immagini resteranno da sole; altre apriranno una storia.</p>\n          <a class="read-link" href="/fotografie.html">Entra nell’archivio fotografico <span>↗</span></a>\n        </div>\n      </div>\n    </section>\n'''

EN_PHOTO_SECTION = '''\n    <section class="photo-door" id="photography">\n      <div class="photo-door-inner reveal">\n        <div>\n          <p class="kicker">04 · Photography</p>\n          <h2>Images\nthat remember.</h2>\n        </div>\n        <div class="photo-door-copy">\n          <p>Original photographs, places and memory. Some images will stand alone; others will open into a story.</p>\n          <a class="read-link" href="/photography.html">Enter the photographic archive <span>↗</span></a>\n        </div>\n      </div>\n    </section>\n'''


def patch_home(filename: str, language: str) -> None:
    path = ROOT / filename
...
def patch_sitemap() -> None:
    ...
    source = path.read_text(encoding='utf-8')
    additions = []
    if 'https://www.andreamorel.com/fotografie.html' not in source:
        additions.append('  <url><loc>https://www.andreamorel.com/fotografie.html</loc><lastmod>2026-08-09</lastmod></url>')
    if 'https://www.andreamorel.com/photography.html' not in source:
        additions.append('  <url><loc>https://www.andreamorel.com/photography.html</loc><lastmod>2026-08-09</lastmod></url>')
    if additions:
