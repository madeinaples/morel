(() => {
  ...
  const routes = {
    '/storie/dove-guardano-gli-uomini-all-orinatoio': {
      ...
      archive: '/archivio.html', label: 'Continua il pensiero', cta: 'Continua', archiveLabel: 'Archivio'
    },
    '/stories/where-do-men-look-at-the-urinal': {
      ...
      archive: '/archive.html', label: 'Continue the thought', cta: 'Continue', archiveLabel: 'Archive'
    },
    ...
    '/storie/perche-non-mi-hai-capita-amanda-lear-dali': {
      lang: 'it',
      question: 'Forse essere conosciuti da molto tempo non significa necessariamente essere conosciuti bene. A volte chi ci conosce da sempre continua a conoscere soprattutto chi eravamo.',
      next: '/storie/mi-conosci-da-sempre-ma-mi-conosci-davvero.html',
      archive: '/archivio.html', label: 'Continua il pensiero', cta: 'Continua', archiveLabel: 'Archivio'
    },
    '/stories/why-didnt-you-understand-me-amanda-lear-dali': {
      lang: 'en',
      question: "Perhaps being known for a long time doesn't necessarily mean being known well. Sometimes the people who've known us forever still know mostly who we used to be.",
      next: '/stories/youve-known-me-forever-but-do-you-really-know-me.html',
      archive: '/archive.html', label: 'Continue the thought', cta: 'Continue', archiveLabel: 'Archive'
    },
    '/storie/mi-conosci-da-sempre-ma-mi-conosci-davvero': {
      lang: 'it',
      question: 'Ma cosa succede quando ciò che non raccontiamo non è più un dettaglio?',
      next: '/storie/il-matrimonio-che-sua-madre-non-sapra.html',
      archive: '/archivio.html', label: 'Continua il pensiero', cta: 'Continua', archiveLabel: 'Archivio'
    },
    '/stories/youve-known-me-forever-but-do-you-really-know-me': {
      lang: 'en',
      question: "But what happens when what we don't tell them is no longer just a detail?",
      next: '/stories/the-wedding-his-mother-will-never-know-about.html',
      archive: '/archive.html', label: 'Continue the thought', cta: 'Continue', archiveLabel: 'Archive'
    }
  };
  ...
  if (!document.querySelector('#morel-thread-engine-styles')) {
    ...
    style.textContent = `
      .morel-thread-door { margin: clamp(72px, 10vw, 140px) 0 20px; padding: clamp(30px, 5vw, 58px) 0 10px; border-top: 1px solid rgba(238,233,222,.2); }
      .morel-thread-door__label { margin: 0 0 22px; color: #9b9d97; font: 10px/1.4 "DM Sans",Arial,sans-serif; letter-spacing: .22em; text-transform: uppercase; }
      .morel-thread-door__question { max-width: 760px; margin: 0; color: #eee9de; font: clamp(30px,4.2vw,58px)/1.08 "Newsreader",Georgia,serif; letter-spacing: -.025em; }
      .morel-thread-door__actions { display:flex; flex-wrap:wrap; align-items:center; gap:18px 28px; margin-top:34px; }
      .morel-thread-door__continue { display:inline-flex; align-items:center; gap:24px; min-height:48px; padding:13px 18px; border:1px solid rgba(238,233,222,.42); background:#eee9de; color:#090b0b; text-decoration:none; font:10px/1 "DM Sans",Arial,sans-serif; letter-spacing:.16em; text-transform:uppercase; transition:transform .2s ease,background .2s ease; }
      .morel-thread-door__continue:hover,.morel-thread-door__continue:focus-visible { transform:translateY(-2px); background:#d9d3c8; }
      .morel-thread-door__archive { color:#9b9d97; text-decoration:none; font:10px/1.4 "DM Sans",Arial,sans-serif; letter-spacing:.14em; text-transform:uppercase; }
      .morel-thread-door__archive:hover,.morel-thread-door__archive:focus-visible { color:#eee9de; }
      .morel-thread-door + .article-end { display:none !important; }
      @media (max-width:700px) { .morel-thread-door { margin-top:64px; padding-top:28px; } .morel-thread-door__question { font-size:clamp(30px,9vw,44px); } }
    `;
